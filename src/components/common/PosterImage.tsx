...
const GRADIENTS: Record<string, string> = {
  music: 'linear-gradient(135deg, #2EF6F6 0%, #0B4548 100%)',
  ...
  community: 'linear-gradient(135deg, #7C8FE0 0%, #303F7A 100%)',
  food: 'linear-gradient(135deg, #f97316 0%, #dc2626 100%)',
  default: 'linear-gradient(135deg, #271E33 0%, #14101E 100%)',
};
